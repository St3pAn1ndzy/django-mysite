...
class OrderAdmin(ExportAsCSVMixin, admin.ModelAdmin):
    ...
    def import_csv(self, request: HttpRequest) -> HttpResponse:
        ...
        if form.is_valid():
            csv_file = TextIOWrapper(form.cleaned_data["csv_file"].file, encoding=request.encoding)
            reader = DictReader(csv_file)

            for row in reader:
                products_str = row.pop("products", "")
